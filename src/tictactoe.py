...
class TicTacToe(Challenge):
    ...
    def finished(self):
        if (self.moves['1a'] != '-' and
                self.moves['1a'] == self.moves['1b'] and
                self.moves['1a'] == self.moves['1c']):
            return self.moves['1a']
        elif (self.moves['2a'] != '-' and
              self.moves['2a'] == self.moves['2b'] and
              self.moves['2a'] == self.moves['2c']):
            return self.moves['2a']
        elif (self.moves['3a'] != '-' and
              self.moves['3a'] == self.moves['3b'] and
              self.moves['3a'] == self.moves['3c']):
            return self.moves['3a']

        elif (self.moves['1a'] != '-' and
              self.moves['1a'] == self.moves['2a'] and
              self.moves['1a'] == self.moves['3a']):
            return self.moves['1a']
        elif (self.moves['1b'] != '-' and
              self.moves['1b'] == self.moves['2b'] and
              self.moves['1b'] == self.moves['3b']):
            return self.moves['1b']
        elif (self.moves['1c'] != '-' and
              self.moves['1c'] == self.moves['2c'] and
              self.moves['1c'] == self.moves['3c']):
            return self.moves['1c']

        elif (self.moves['1a'] != '-' and
              self.moves['1a'] == self.moves['2b'] and
              self.moves['1a'] == self.moves['3c']):
            return self.moves['1a']
        elif (self.moves['1c'] != '-' and
              self.moves['1c'] == self.moves['2b'] and
